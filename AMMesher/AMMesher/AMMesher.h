...
#define AM_MESHER_MESHING_NOTIFICATION @"Mesher meshing notification"
#define AM_MESHER_MESHED_NOTIFICATION @"Mesher meshed notification"
#define AM_MESHER_UNMESHED_NOTIFICATION @"Mesher unmeshed notification"
