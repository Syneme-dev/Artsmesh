...
- (void)registerPreference {
    ...
    NSDictionary *registrationDomainDefaultsValues =
            [NSDictionary dictionaryWithObjectsAndKeys:
             ...
             Preference_Active_Theme,            Preference_Key_Active_Theme,
             ...
             @"22243", Preference_OSC_Client_TxPort,
             @"user",  Preference_OSC_Client_UserName,
             @"default", Preference_OSC_Client_UserPwd,
             @"group", Preference_OSC_Client_GroupName,
             @"default", Preference_OSC_Client_GroupPwd,
             @"127.0.0.1", Preference_OSC_Client_MonitorAddr,
             @"22230", Preference_OSC_Client_MonitorPort,
             @"P2P CLIENT", Preference_Jacktrip_Role,
             @"0", Preference_Jacktrip_HubMode,
             @"2", Preference_Jacktrip_SendChannels,
             @"2", Preference_Jacktrip_ReceiveChannels,
             @"-1", Preference_Jacktrip_BufStrategy,
