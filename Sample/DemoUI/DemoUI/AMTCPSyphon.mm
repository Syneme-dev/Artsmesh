...
@interface AMTCPSyphon ()

@end

@implementation AMTCPSyphon
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    [nc addObserver:self selector:@selector(OnNotify_ChangeTCPSyphonServerList:) name:TL_TCPSyphonSDK_ChangeTCPSyphonServerListNotification object:nil];
...
- (void)OnNotify_ChangeTCPSyphonServerList:(NSNotification *)aNotification
{
    ...
    TL_TCPSyphonSDK*    sdk = [glView GetTCPSyphonSDK];
